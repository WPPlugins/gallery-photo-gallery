...
class AYS_Gallery_Site{
    ...
    <ul>';
        ...
        foreach ($ays_gall_images_array as $ays_ind => $ays_gall_img) {
            $ays_gall_site_path_2 .='<li><a href="'.$ays_gall_img.'" data-imagelightbox="e"><img src="'.$ays_gall_img.'" alt="'.$ays_gall_images_alts_array[$ays_ind].'" title="'.$ays_gall_images_title_array[$ays_ind].'" ays_desc="'.$ays_gall_images_descs_array[$ays_ind].'" ays_url="'.$ays_gall_images_urls_array[$ays_ind].'"/></a></li>';
        }
